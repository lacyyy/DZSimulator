...
void MenuWindow::ShowAppExplanation()
{
    _gui_state.popup.QueueMsgInfo(
        "This is a custom version of the \"Danger Zone Simulator\", a Bump Mine "
        "practice tool, rudimentarily modified and fixed up to load \"Counter-"
        "Strike: Classic Offensive\" maps for the sole purpose of finding spots "
        "in CSCO maps whose physics geometry or clipping needs to get fixed up."
        "\n\n"
        "Only map geometry that is solid to players is loaded. And grenade "
        "clips.\n"
        "Of all displacements, only those with hull collision enabled "
        "are loaded.\n"
        "Some physics models (.phy) fail to load, you'll get a warning once "
        "that happens.\n\n"
        "You can show/hide player and grenade clips using their transparency "
        "settings, see the \"Visualizations\" menu section.\n\n"
        "Map objects that are able to move are not loaded.\n"
        "Ladders are not functional.\n"
        "Don't use left-click. The thrown Bump Mine does not behave like a "
        "grenade in CSGO/CSCO, so don't use it to test grenade collisions on a "
        "map!\n\n"
        "For questions, you might message me on Discord, Steam or Twitter/X. "
        "The \"About\" menu section lists my profiles."
    );
}
